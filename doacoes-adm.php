                         ...
                         <?php 
                          ...
                          while($res_1 = mysqli_fetch_array($result)){
                            ...
                            <tr>
                             ...
                             <td>
                             <a class="btn btn-info" href="doacoes-adm.php?func=edita&id=<?php echo $id; ?>"><i class="fa fa-pencil-square-o"></i></a>

                             <a  class="btn btn-danger" href="doacoes-adm.php?func=deleta&id=<?php echo $id; ?>"><i class="fa fa-minus-square"></i></a>
...
if($result == ''){
  echo "<script language='javascript'> window.alert('Ocorreu um erro ao Cadastrar!'); </script>";
    ...
    echo "<script language='javascript'> window.location='doacoes-adm.php'; </script>";
}

...
<div class="container">
      ...
      <div class="row">
           <div class="col-sm-12">
              ...
              <div class="container">
              <div class="row">
              <button type="button" class="btn btn-secondary mb-3" data-toggle="modal" data-target="#modalExemplo"  >Novo registro </button>
                      ...
                      <?php
                        ...
                        if(isset($_GET['buttonPesquisar']) and $_GET['txtpesquisar'] != ''){
                          $nome = $_GET['txtpesquisar'] . '%';
                           $query = "select * from financeiro where nome LIKE '$nome'  order by nome asc"; 
                        ...
                        //final do código
                         ...
                         $query = "select * from financeiro order by destino asc"; 
                        }
                         ...
                         <?php 
                          ...
                          while($res_1 = mysqli_fetch_array($result)){
                            ...
                            <tr>
                             ...
                             <td>
                             <a class="btn btn-info" href="financeiro.php?func=edita&id=<?php echo $id; ?>"><i class="fa fa-pencil-square-o"></i></a>

                             <a  class="btn btn-danger" href="financeiro.php?func=deleta&id=<?php echo $id; ?>"><i class="fa fa-minus-square"></i></a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="id_produto">Destino</label>
                <input type="text" class="form-control mr-2" name="txtdestino" placeholder="Destino" required>
              </div>
              <div class="form-group">
                <label for="id_produto">Data</label>
                <input type="date" class="form-control mr-2" name="txtdata" id="txtdata" placeholder="Data" required>
              </div>
              <div class="form-group">
...
$query = "INSERT into financeiro (destino, datareg, valor, tipo) VALUES ('$destino', '$datareg', '$valor', '$tipo')";
$result = mysqli_query($conexao, $query);
...
if($result == ''){
  echo "<script language='javascript'> window.alert('Ocorreu um erro ao Cadastrar!'); </script>";
    ...
    echo "<script language='javascript'> window.location='financeiro.php'; </script>";
}
         ...
         <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="id_produto">Destino</label>
                <input type="text" class="form-control mr-2" name="txtdestino" placeholder="Destino" value="<?php echo $res_1['destino']; ?>" required>
              </div>
              <div class="form-group">
                <label for="id_produto">Data</label>
                <input type="date" class="form-control mr-2" name="txtdatareg" id="txtdatareg" placeholder="Data" value="<?php echo $res_1['datareg']; ?>" required>
              </div>
              <div class="form-group">
                <label for="quantidade">Valor</label>
...
$query_editar = "UPDATE financeiro set destino = '$destino', datareg = '$datareg', valor = '$valor', tipo = '$tipo' where id = '$id' ";

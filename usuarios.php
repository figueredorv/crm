            ...
            <div class="modal-body">
              ...
              <div class="input-group mb-3">
                        ...
                        <select name="tipo" class="custom-select" id="inputGroupSelect01">
                          <option seleced value="1"> Funcionário - Usuário comum</option>
                          <option seleced value="2"> Administrador - Usúario com acesso administrativo</option>
                        </select>
                      </div>
         ...
         <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <select name="tipo" class="custom-select" id="inputGroupSelect01">
                          <option selected><?php echo $res_1['cargo']; ?></option>
                          <option value="1"> Funcionário - Usuário comum</option>
                          <option value="2"> Administrador - Usúario com acesso administrativo</option>
                        </select>
                        <small class="text-muted"> Nível de acesso ao sistema</small>
                      </div>
